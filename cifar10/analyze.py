...
if __name__ == "__main__":
    latex_table_certified_accuracy(
        "analysis/latex/vary_noise_cifar10", 0.25, 1.5, 0.25, [
            ##Line(ApproximateAccuracy("results/cifar10_sigma_0.12"), "$\sigma = 0.12$"),
            Line(ApproximateAccuracy("results/cifar10_sigma_0.25"), "$\sigma = 0.25$"),
            Line(ApproximateAccuracy("results/cifar10_sigma_0.50"), "$\sigma = 0.50$"),
            Line(ApproximateAccuracy("results/cifar10_sigma_1.00"), "$\sigma = 1.00$"),
        ])
